...
export type Project = EntityBase<"Project"> & {
  ...
  createdBy: User | null // The user who created the project. Can be null.
  customFields: ProjectCustomField[] // The set of custom fields that are available in the project.
  description: string | null // The description of the project as shown on the project profile page. Can be null.
  fromEmail: string // The email address used to send notifications for the project. Returns default address if not set.
  iconUrl: string | null // The URL of the icon of the project. Read-only. Can be null.
  issues: Issue[] // A list of all issues that belong to the project.
  leader: User | null // The user who is set as the project owner. Can be null.
  name: string | null // The name of the project. Can be null.
  replyToEmail: string | null // The email address used as the reply email for notifications. Can be null.
  shortName: string | null // The ID of the project. This short name is also a prefix for an issue ID. Can be null.
...
export type CustomFieldCondition = EntityBase<"CustomFieldCondition"> & {
  parent: ProjectCustomField | null // The custom field that is hidden behind the condition. Can be null.
}
